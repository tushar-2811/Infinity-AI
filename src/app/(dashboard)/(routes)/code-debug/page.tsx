...
import { Code2Icon, CodeSquare, MessagesSquare, Move3D } from 'lucide-react'
...
const page = () => {
  ...
  const onSubmit = async (data: z.infer<typeof conversationSchema>) => {
      try {
        ...
        const response = await axios.post("/api/code-debug" , {
  ...
  return (
    <div>
      <Heading
        title="Code De-Bug"
        description="Use AI model to debug your faulty code"
        Icon={CodeSquare}
                  ...
                  <FormItem className="col-span-12 lg:col-span-10">
                    <FormControl className="m-0 p-0">
                      <Input
                        ...
                        disabled={isLoading}
                        placeholder="Copy your code and Paste it here here."
                        {...field}
                      />
                    </FormControl>
                  </FormItem>
